...
# --- CONFIGURACIÓN V10 (Sin Group By Length) ---
...
# 1. LÍMITE FÍSICO (Pared de la GPU)
MAX_TOTAL_TOKENS = 1800 

# 2. EL FILTRO (Portero de seguridad)
MAX_TEXT_TOKENS_FILTER = 1500

def train():
    print(f"🚀 [04a-V10] Iniciando: Streaming + Filtro Seguro ({MAX_TEXT_TOKENS_FILTER})...")
    
    processor = AutoProcessor.from_pretrained(MODEL_ID)
    tokenizer = processor.tokenizer
    
    # Modo Streaming (Indispensable para tu RAM)
    ...
    def filter_fn(example):
        ...
        # Filtramos para asegurar que quepan texto + imagen
    ...
    training_args = TrainingArguments(
        ...
        # group_by_length ELIMINADO por incompatibilidad con Streaming
    )

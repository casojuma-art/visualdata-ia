...
# Mantenemos los límites de seguridad
MAX_TOTAL_TOKENS = 1800 
MAX_TEXT_TOKENS_FILTER = 1500

def train():
    print(f"🚀 [04a-V12] Iniciando: MODO SPORT (Batch 2) + Shuffle + Filtro...")
    ...
    training_args = TrainingArguments(
        ...
        # --- CAMBIOS V12: MÁS POTENCIA ---
        per_device_train_batch_size=2,      # Antes 1. Ahora cargamos 2 fotos a la vez.
        gradient_accumulation_steps=16,     # Antes 32. Ajustamos para mantener el total en 32.
        # ---------------------------------
        learning_rate=2e-4,
        max_steps=19800,
        save_steps=1000,
        ...
        dataloader_num_workers=4            # Subimos workers para alimentar más rápido
    )
